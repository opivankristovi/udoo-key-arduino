...
| [RepeaterNodeESP32](esp32/RepeaterNodeESP32/) | Wi-Fi NAT repeater + MQTT hub; receives sensor data from RP2040 via UART and forwards output commands |
...
| [RepeaterNodeRP2040](rp2040/RepeaterNodeRP2040/) | Reads 2 I2C sensors, probe, 2 analog + 2 digital inputs; drives 4 outputs; sends data to ESP32 via UART |
